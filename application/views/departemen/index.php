                                            	...
                                            	<?php 
												    $nomor =1;
											 		...
											 		<tr>
												        ...
												        <td class="center"><?php echo $row->abbr; ?></td>
												        <td class="center"><?php echo $row->alamat; ?></td>
												        <td class="center"><?php echo $row->telpon; ?></td>
												        <td class="center">
												            <a class="btn btn-info" href="<?php echo base_url();?>departemen/edit/<?php echo $row->id;?>">
												                Edit
												            </a>
												            <a class="btn btn-warning" href="<?php echo base_url();?>departemen/delete/<?php echo $row->id;?>">
												                delete
												            </a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body card-block">
                                        <form method="POST" action="<?php echo base_url().'departemen/add'?>">
                                        ...
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">ABBR</label>
                                            <input type="text" name="abbr" placeholder="Enter Your NIP" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telpon" placeholder="Enter Your Dep_ID" class="form-control">
                                        </div>
                                        <div class="form-group"> 
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary">
                                <a href="<?php echo base_url();?>departemen/delete/<?php echo $row->id;?>" class="c-white-1">
                                Yes
                                </a>
                            </button>
                        </div>
